	...
	public void inicializar() throws IOException {
		...
		botonera = new Botonera() {
			...
			public void guardar() {
				...
				medicion.setDescripcionMedicion(txtDescripcionMedicion.getValue());
				medicion.setUsuario("JDE");
				medicion.setFechaAuditoria(new Timestamp(new Date().getTime()));
				medicion.setHoraAuditoria(horaAuditoria);
